...
- **Enterprise Form Management**:
  ...
  - Disabled browser HTML5 default validations (`noValidate`).
  - Real-time field error indicators and toast notifications (`react-hot-toast`) on submission.
- **Dynamic Document Titles**: Automatically updates browser `document.title` based on the active viewport section and tab selections.

## 🛠️ Technology Stack

- **Frontend**: React 19, Vite, Tailwind CSS v4, Lucide React
- **Form & Validation**: React Hook Form, Joi (`@hookform/resolvers/joi`), React Hot Toast
- **Build & Tools**: PostCSS, Autoprefixer, Oxlint

## 🏁 Getting Started

```bash
# Clone the repository
git clone https://github.com/priyankgondaliya/Helionix.git
